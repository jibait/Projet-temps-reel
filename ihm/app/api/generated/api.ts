 ...
 * @version 1.0.0
 *
 * API pour envoyer et récupérer des messages de chat
 */
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  messages = {
     ...
     *
     * @name MessagesList
     * @summary Récupérer tous les messages de chat
     ...
     *
     * @name MessagesCreate
     * @summary Créer un nouveau message de chat
     * @request POST:/messages
     */
    messagesCreate: (data: Message, params: RequestParams = {}) =>
      this.request<Message, any>({
        path: `/messages`,
        method: "POST",
        body: data,
